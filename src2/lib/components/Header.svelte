...
<header  class:is-home-page={$isHomePage}>
    <nav id="menu" class="custom-container mx-auto ">
      <div class="custom-container flex justify-between items-center ">
        <a href="/" class="text-lg font-bold flex items-center space-x-2">
          <img src="https://prismatic-vacherin-4f22e8.netlify.app/logo.png" alt="logo" class="h-10 w-10"> 
          <span class="uppercase font-thin text-2xl">HK Portfolio</span>
        </a>
